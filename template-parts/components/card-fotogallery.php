<?php 
  ...
  $mobile = $fotogallery_img ? konkord_resolve_mobile_sources( $fotogallery_img ) : null;
   if($fotogallery_img) : 
  ?>
    <a data-fslightbox="fotogallery-<?php echo $page_id ?>" data-caption="" href="<?php echo $fotogallery_url ?>" class="card-fotogallery__link" aria-label="Открыть фото в галерее">
