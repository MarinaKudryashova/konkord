...
<section class="<?php echo esc_attr($sec_class); ?>">
  <div class="sec-reviews__container container">
    ...
    <div class="sec-reviews__widgets" data-lazy-section>
      ...
      <div class="sec-reviews__widget-map"><?php echo konkord_reviews_widget_html( $sec_reviews_widget_map ); ?></div>
      <?php endif; ?>

      <?php if($sec_reviews_widget_reviews) : ?>
      <div class="sec-reviews__widget-reviews"><?php echo konkord_reviews_widget_html( $sec_reviews_widget_reviews ); ?></div>
      <?php endif; ?>
    </div>
    <?php endif; ?>
